...
export default function SimulationTutorialContent({
  isCompleted,
  onComplete,
}: SimulationTutorialContentProps) {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      // Trigger download
      downloadClient.triggerDownload(
        data.downloadUrl,
        `simulation-${selectedOS}`
      );
        ...
        <Stack gap="lg">
          ...
          <Box style={downloadSectionStyle}>
            <Text style={sectionTitleStyle}>
              Download Simulation Application
            </Text>
            <Text style={bodyTextStyle}>
              Before you can begin the simulation, you need to download and
              install the application on your computer.
            </Text>

            <Text style={subsectionTitleStyle}>
              Step 1: Select Your Operating System
            </Text>
            <Radio.Group
              value={selectedOS}
              onChange={(value: string) =>
                setSelectedOS(value as "windows" | "mac")
              }
            ...
            <Text style={bodyTextStyle}>
              Click the download button below to get the application for your
              selected operating system. The file will be saved to your
            ...
            <Center>
              <Button
                ...
                style={{
                  backgroundColor:
                    selectedOS && !isDownloading ? "#0ea5e9" : "#9ca3af",
                  border: "none",
                  borderRadius: "12px",
                  fontSize: "16px",
                  fontWeight: 600,
          ...
          <Box style={highlightBoxStyle}>
            ...
            <List>
              ...
              <List.Item>
                Instructions for interacting with the virtual patient
              </List.Item>
          ...
          <Grid gutter="xl">
            <Grid.Col span={{ base: 12, md: 6 }}>
              ...
              <List>
                ...
                <List.Item>
                  Maintain a patient-centered, empathetic tone
                </List.Item>
                <List.Item>
                  Flexibly collect relevant medical and personal history
                </List.Item>
                <List.Item>
                  Acknowledge and validate the patient's emotional experience
                </List.Item>
                <List.Item>
                  Initiate collaborative, goal-oriented care planning
                </List.Item>
              </List>

              <Text style={sectionTitleStyle}>
                How to Interact with the Virtual Patient
              </Text>
              <Text style={bodyTextStyle}>
                The simulation mirrors a real-world therapy session with a
                virtual patient diagnosed with Broca's aphasia.
              </Text>
              ...
              <Text style={listItemStyle}>• Click 'Log in'.</Text>

              <Text style={subsectionTitleStyle}>
                2. Initiating Communication
              </Text>
              <Text style={listItemStyle}>
                • The virtual patient will appear on screen.
              </Text>
              <Text style={listItemStyle}>
                • Press the 'R' key to begin speaking, hold the R key while
                speaking.
              </Text>
              <Text style={listItemStyle}>
                • When finish speaking, release the R key.
              </Text>
              <Text style={listItemStyle}>
                • The patient will respond after your turn.
              </Text>
              <Text style={listItemStyle}>
                • Press 'R' again to continue the dialogue.
              </Text>
              <Text style={listItemStyle}>
                • Turns will alternate, as in a live session.
              </Text>

              <Text style={subsectionTitleStyle}>
                3. Engaging in the Session
              </Text>
              <Text style={listItemStyle}>
                • Use clinical skills to guide the conversation.
              </Text>
              <Text style={listItemStyle}>
                • There is no fixed script; every session is flexible and
                responsive.
              </Text>
              <Text style={listItemStyle}>
                • The session can be ended anytime by clicking "Finish."
              </Text>

              <Text style={subsectionTitleStyle}>4. Receiving Feedback</Text>
              <Text style={listItemStyle}>
                • After the session, an AI-generated feedback report will be
                immediately received.
              </Text>
              <Text style={listItemStyle}>
                • The report includes assessment in the following areas:
              </Text>
              <Box ml="md">
                <Text style={listItemStyle}>
                ...
                <Text style={listItemStyle}>
                  • Responsiveness to Patient's Feedback
                </Text>
              </Box>
              <Text style={listItemStyle}>
                • Feedback can be revisited anytime via the dashboard.
              </Text>
            </Grid.Col>
            ...
            <Grid.Col span={{ base: 12, md: 6 }}>
              ...
              <Text style={bodyTextStyle}>
                Users can explore communication strategies, make mistakes, and
                learn through hands-on experience.
              </Text>

              <Text style={subsectionTitleStyle}>B. Realistic Interaction</Text>
              <Text style={bodyTextStyle}>
                Users will engage with a lifelike virtual patient who simulates
                the challenges of Broca's aphasia.
              </Text>

              <Text style={subsectionTitleStyle}>
                C. Skill Development Focus
              </Text>
              <Text style={bodyTextStyle}>
              ...
              <Text style={subsectionTitleStyle}>
                D. Immediate, Personalized Feedback
              </Text>
              <Text style={bodyTextStyle}>
              ...
              <Text style={subsectionTitleStyle}>
                E. No Grades or Evaluations
              </Text>
              <Text style={bodyTextStyle}>
                This is a formative, low-stakes environment focused on learning,
                not performance.
              </Text>

              <Text style={subsectionTitleStyle}>
                F. Opportunities for Reflection
              </Text>
              <Text style={bodyTextStyle}>
                A debriefing and feedback interview allows reflection on the
                experience and helps shape future simulations.
              </Text>

              <Text style={subsectionTitleStyle}>G. Self-Paced Format</Text>
              <Text style={bodyTextStyle}>
                Users control the pace—they can start, pause, and complete the
                simulation on their own schedule.
              </Text>
            </Grid.Col>
          </Grid>
