...
export default function SimulationLevel({
  ...
  const [midSurveyResponses, setMidSurveyResponses] = useState({
    ...
    'I feel more confident applying these skills when working with other health professionals.': null as number | null,
    'The simulation encouraged me to reflect on my clinical reasoning during and after the session.': null as number | null,
    'The simulation kept me engaged and motivated to practice new strategies.': null as number | null,
